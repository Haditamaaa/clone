...
(()=>{
    var t = {
        484: function(t) {
            t.exports = function() {
                ...
                var S = function() {
                    ...
                    ,
                    v.$set = function(t, e) {
                        var n, c = M.p(t), l = "set" + (this.$u ? "UTC" : ""), f = (n = {},
                        n[o] = l + "Date",
                        n[p] = l + "Date",
                        n[u] = l + "Month",
                        n[d] = l + "FullYear",
                    ...
                    v.format = function(t) {
                        ...
                        var s = t || "YYYY-MM-DDTHH:mm:ssZ"
                          ...
                          , u = n.months
                          , l = function(t, n, i, r) {
                            return t && (t[n] || t(e, s)) || i[n].substr(0, r)
                        }
                          , d = function(t) {
                    ...
                    v.diff = function(s, p, f) {
                        var h, m = M.p(p), g = x(s), v = (g.utcOffset() - this.utcOffset()) * e, _ = this - g, w = M.m(this, g);
                        return w = (h = {},
                        h[d] = w / 12,
                        h[u] = w,
                        h[l] = w / 3,
                ...
                [["$ms", s], ["$s", i], ["$m", r], ["$H", a], ["$W", o], ["$M", u], ["$y", d], ["$D", p]].forEach((function(t) {
                    k[t[1]] = function(e) {
        ...
        646: function(t) {
            t.exports = function() {
                "use strict";
                var t, e, n = 1e3, s = 6e4, i = 36e5, r = 864e5, a = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, o = 31536e6, c = 2592e6, u = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, l = {
                    years: o,
                    months: c,
                    days: r,
                    hours: i,
                    ...
                    g.get = function(t) {
                        var e = this.$ms
                          , n = f(t);
                        return "milliseconds" === n ? e %= 1e3 : e = "weeks" === n ? m(e / l[n]) : this.$d[n],
                        0 === e ? 0 : e
                    }
                    ,
                    g.add = function(t, e, n) {
                        var s;
                        return s = e ? t * l[f(e)] : d(t) ? t.$ms : p(t, this).$ms,
            ...
            t.exports = function() {
                ...
                return function(s, i, r) {
                    ...
                    a.utcOffset = function(s, i) {
                        var r = this.$utils().u;
                        if (r(s))
                            return this.$u ? 0 : r(this.$offset) ? u.call(this) : this.$offset;
    ...
    n.d = (t,e)=>{
        for (var s in e)
            n.o(e, s) && !n.o(t, s) && Object.defineProperty(t, s, {
                enumerable: !0,
                get: e[s]
            })
    }
    ...
    (()=>{
            ...
            for (let s = 0; s < r.workHours.length; s++) {
                ...
                if (-1 === h(i, c)) {
                    ...
                    1e3 * (3600 * (a.hour - o.hour) + 60 * (a.minute - o.minute)))
                      ...
                      , d = ` ${r.get("hours")}${u.hour}:${r.get("minutes")}${u.minute} `;
            ...
            if ("ON" == e.enabledFacebook || "ON" == e.enabledGoogle) {
                ...
                "ON" === e.enabledGoogle) {
                    if ("undefined" != typeof gtag)
                        ...
                        "undefined" != typeof __gaTracker && __gaTracker("send", "event", a, o, c);
        ...
        const $ = function(t, e) {
          ...
          , x = function(t, e) {
            ...
            if ("OFF" == n.options.display.showOnDesktop && !w)
                return;
            if ("OFF" == n.options.display.showOnMobile && w)
                return;
            ...
            o.append((()=>{
                ...
                t.style.color = "#fff" == s.textColor || "#ffffff" == s.textColor ? "#D9EBC6" : s.textColor + "; opacity: 0.8",
                t
            }
            )());
            ...
            c.appendChild((()=>{
                ...
                return s.setAttribute("for", "nta-wa-gdpr"),
                s.appendChild(e),
                s
            }
            )());
            ...
            u.appendChild("ON" == s.isShowGDPR && 1 == n.gdprStatus ? c : document.createTextNode("")),
            u.appendChild((()=>{
                const t = document.createElement("div");
                var e;
                return t.className = "wa__popup_content_list",
                t.onclick = function() {
                    "" == g("nta-wa-gdpr") && (c.style.background = "red",
                    c.style.color = "#fff")
                }
                ,
                e = t,
                n.accounts.forEach((t=>{
                    ...
                    a.appendChild((()=>{
                        ...
                        e.appendChild((()=>{
                            ...
                            let n = "";
                            return n += `<div class="wa__member_name">${t.accountName}</div>`,
          ...
          , M = function(t, e) {
            ...
            c.appendChild(n.name ? (()=>{
                ...
                t.appendChild((()=>{
                    ...
                    t.innerHTML = "online" === i ? n.i18n.online : n.i18n.offline,
                    t
                }
                )()),
                t
